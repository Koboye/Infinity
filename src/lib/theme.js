/**
 * Altimate — Design Tokens (Green / Gold / Red)
 * ------------------------------------------------------------------
 * Same token shape as Infinity (COLORS, TYPE, RADIUS, SHADOW, Z ...) so the
 * code reads the same, but the palette follows the Altimate design:
...
export const COLORS = {
  ...
  bg: '#F4F7F5',
  surface: '#FFFFFF',
  surfaceAlt: '#EEF3F0',   // fields, cards, pressed states

  // Brand (deep teal → green, the Altimate identity)
  brand: '#0E7A55',
  brandDeep: '#0B4A3D',
  brand2: '#12996B',
  brandSoft: '#D9F0E4',
  brandTextFill: '#0E7A55', // solid fill that carries white text
  brandGradient: 'linear-gradient(135deg, #0B3B39 0%, #0E7A55 55%, #14A66E 100%)',
  textOnBrand: '#FFFFFF',
  ...
  // Extra accents for stat tiles (info = sales, accent = outstanding)
  info: '#2E6BE8',
  infoSoft: '#DEE8FD',
  accent: '#E8821E',
  accentSoft: '#FBE8D2',
...
export const COLORS_DARK = {
  ...
  brandGradient: 'linear-gradient(135deg, #07211E 0%, #0E4A3B 55%, #17734F 100%)',
  textOnBrand: '#FFFFFF',
