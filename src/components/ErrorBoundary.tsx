  ...
  render() {
    ...
    return (
      <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', minHeight:'60vh', gap:16, padding:32, textAlign:'center' }}>
        ...
        <button onClick={this.reset} style={{ background:'linear-gradient(135deg,#FF2156,#9D4EDD)', border:'none', color:'white', borderRadius:16, padding:'12px 24px', fontSize:14, fontWeight:600, cursor:'pointer' }}>Try again</button>
      </div>
    );
  }
}
