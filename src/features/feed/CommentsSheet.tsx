      ...
      <div style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{
                  ...
                  {c.pinned && (
                    <span style={{
                      fontSize: 10,
                      background: 'rgba(255,33,86,0.15)',
                      color: '#FF2156',
                      borderRadius: 4,
                      padding: '1px 6px',
                      fontWeight: 700
        ...
        {replyTo && (
          <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            padding: '8px 16px',
            background: 'rgba(255,33,86,0.08)',
            borderTop: '1px solid rgba(255,33,86,0.15)'
          }}>
            <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)' }}>
              Replying to{' '}
              <span style={{ color: '#FF2156', fontWeight: 700 }}>@{replyTo.username}</span>
            </span>
            <button
        ...
        {/* Input row */}
        <div style={{
          display: 'flex', gap: 10, padding: '12px 16px 32px',
