      ...
      <div style={{
            ...
            <div key={c.id} style={{ display: 'flex', gap: 10 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 3 }}>
                  ...
                  {c.pinned && (
                    <span style={{ fontSize: 10, background: 'rgba(107,78,255,0.15)', color: '#5B4EE8', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>📌 Pinned</span>
                  )}
        ...
        {replyTo && (
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 16px', background: 'rgba(107,78,255,0.08)', borderTop: '1px solid rgba(107,78,255,0.15)' }}>
            <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)' }}>
              Replying to <span style={{ color: '#5B4EE8', fontWeight: 700 }}>@{replyTo.username}</span>
            </span>
        ...
        <div style={{ display: 'flex', gap: 10, padding: '12px 16px 32px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <button
            ...
            style={{ background: text.trim() ? 'linear-gradient(135deg,#5B4EE8,#9D7BFF)' : 'rgba(255,255,255,0.07)', border: 'none', color: 'white', borderRadius: 999, width: 40, height: 40, cursor: 'pointer', fontSize: 18, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}
          >
            ➤
          </button>
        </div>
